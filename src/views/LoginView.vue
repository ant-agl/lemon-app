<template>
  <div class="login-form-container">
    <div class="form-container">
      ...
      <p  class="forgot-password"><router-link to="/forgot" class="link ">Забыли пароль?</router-link></p>
      ...
      <p class="privacy-policy-text">
        ...
        <router-link to="/register" class="link">правилами обработки персональных данных</router-link>
      </p>
...
export default {
  ...
  methods: {
    ...
    validateEmail() {
      ...
      this.emailError =
        (!this.email || !emailRegex.test(this.email)) && this.formSubmitted
          ? "Неверно указан адрес электронной почты"
          : "";
    },
    validatePassword() {
      this.passwordError =
        (!this.password || this.password.length < 8) && this.formSubmitted
